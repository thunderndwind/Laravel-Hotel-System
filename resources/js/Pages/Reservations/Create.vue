                        ...
                        <form @submit.prevent="submitForm">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="col-span-2">
                                    ...
                                    />
                                    <InputError
                                        :message="form.errors.accompany_number"
                                        class="mt-2"
                                    />
                                    <p
                                        v-if="room"
                                ...
                                <div
                                    v-if="canShowSummary"
                                    class="col-span-2 p-4 bg-gray-50 rounded-lg"
                                >
                                    <h3
...
const submitForm = () => {
    ...
    form.post(route("reservations.store"), {
        ...
        onError: () => {
            ToastService.loadingToError(
                toastId,
                "Error",
                "There was a problem booking your reservation.",
            );
        },
    });
};
...
const checkAvailability = () => {
    if (form.room_id && form.check_in_date && form.check_out_date) {
        ...
        router.post(
            route("reservations.check-availability"),
            {
