                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    ...
                                    <div>
                                        <InputLabel
                                            ...
                                            value="Number of Guests (excluding you)"
                                        />
                                        <TextInput
                                            id="accompany_number"
...
const calculateTotalPrice = () => {
    if (!selectedRoom.value || !form.check_in_date || !form.check_out_date)
        return "0.00";
